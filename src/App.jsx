...
import TwoStepVerification from "./pages/auth/TwoStepVerification.jsx";
    ...
    <ThemeProvider defaultTheme="light">
      <Routes>
        ...
        <Route
          ...
          element={!isAuthenticated ? <EmailVerification /> : <Navigate to="/" />}
        />
        <Route
          path="/two-step-verification"
          element={!isAuthenticated ? <TwoStepVerification /> : <Navigate to="/" />}
        />
        <Route path="/lock-screen" element={<LockScreen setIsAuthenticated={setIsAuthenticated} />} />
