    ...
    <>
      ...
      <div className="min-h-screen bg-gray-50 py-6 sm:py-8 font-[Inter] px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto">
          ...
          {/* Navigation Tabs */}
          <div className="mb-6 sm:mb-8 justify-center items-center text-center">
                        ...
                        <tr key={module.id} className="hover:bg-gray-50">
                          <td className="px-4 sm:px-6 py-3 sm:py-4 whitespace-nowrap">
                            <div className="flex items-center">
                              <div className={`w-8 h-8 smევ
                                sm:w-10 sm:h-10 rounded-lg flex items-center justify-center ${module.color} bg-opacity-10`}>
                                <module.icon className="w-4 h-4 sm:w-5 sm:h-5" />
                              </div>
                              <div className="ml-3 sm:ml-4">
                                <div className="text-sm font-medium text-gray-900 truncate">{module.title}</div>
                ...
                <div className="space-y-3">
                  <div className="flex items-start space-x-2 sm:space-x-3 p-2 sm:p-3 bg-orange-50 rounded-lg">
                    ...
                    <div className="flex-1">
                      <p className="text-sm font-medium text-gray-900 truncate">New hire added: John Doe</p>
                  ...
                  <div className="flex items-start space-x-2 sm:space-x-3 p-2 sm:p-3 bg-purple-50 rounded-lg">
                    <DollarSign className="w-4 h-4 sm:w-5 sm:h-5 text-purple-600 mt-1 flex-shrink-0" />
                    <div className="flex-1">
                      <p className="text-sm font-medium text-gray-900 truncate">Payroll processed for this month</p>
